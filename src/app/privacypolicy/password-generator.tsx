  ...
  return (
    <>
      <div className="mx-auto max-w-6xl p-5">
        ...
        <br />
        <p>
          Pranit Patil built the Password Generator app as a Free app. This
          SERVICE is provided by Pranit Patil at no cost and is intended for use
          as is. This page is used to inform visitors regarding my policies with
          ...
          Conditions, which are accessible at Password Generator unless
        ...
        <p>
          ...
          may collect information used to identify you. Link to the privacy
        ...
        <p>
          ...
          page. This policy is effective as of 2025-05-18
        </p>
        <br />
        <h3>Contact Us</h3>
        <p>
          If you have any questions or suggestions about my Privacy Policy, do
          not hesitate to contact me at dev.pranitpatil@gmail.com
        </p>
      </div>
    </>
  );
